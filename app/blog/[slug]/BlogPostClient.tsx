...
type Post = {
    ...
    sections: string[]               // HTML strings — one per "page"
    image_urls?: string[]            // optional per-section images (can be shorter or longer than sections)
}
...
export function BlogPostClient({
    ...
    const perPageImages = post.image_urls || []

    // We show as many "pages" as the longer of the two arrays
    const totalPages = Math.max(sections.length, perPageImages.length) || 1
    ...
    const currentImage = perPageImages[currentPage] || null
